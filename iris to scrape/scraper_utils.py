...
# # def build_scraper(url, sample_list):
# #     """Train a scraper on a given URL with sample elements."""
# #     scraper = AutoScraper()
# #     scraper.build(url, sample_list)
# #     return scraper

# # def test_scraper(scraper, url):
# #     """Test a trained scraper on a URL and return grouped results."""
# #     return scraper.get_result_similar(url, grouped=True)
...
# # def save_config(config_file, site_name, url, config_filename):
# #     """
# #     Forcefully update links.json with the given mapping.
# #     This method is guaranteed to persist on disk.
# #     """
# #     ensure_file_exists(config_file)
...
# #     # Force-write with flush + fsync to ensure durability
# #     with open(config_file, "w", encoding="utf-8") as f:
# #         json.dump(configs, f, indent=4, ensure_ascii=False)
# #         f.flush()
# #         os.fsync(f.fileno())

# #     return configs  # Return updated configs immediately

# # def load_scraper(config_filename):
# #     """Load an existing scraper model from a saved JSON config file."""
# #     scraper = AutoScraper()
# #     scraper.load(config_filename)
# #     return scraper
